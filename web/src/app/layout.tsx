...
export const metadata: Metadata = {
  title: "Supply Chain Management System - Enterprise SCM Platform",
  description: "Modular enterprise supply chain management system with PostgreSQL RLS security, custom REST API, and multi-tenant isolation.",
};
